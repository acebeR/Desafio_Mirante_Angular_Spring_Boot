...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> buscaUsuarioPorId(@PathVariable String login){
		return new ResponseEntity<Usuario>(usuarioService.buscarPorNome(login), HttpStatus.OK);
	}
